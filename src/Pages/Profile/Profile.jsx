...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare data in the format expected by the API - send all fields
    const updateData = {
      name: formData.name,
    ...
    try {
      ...
      if (result.provider) {
        ...
        setFormData({
          ...
          location: {
            address: result.provider.location?.address || "",
          },
          profession: result.provider.profession || "",
          about: result.provider.about || "",
          experience: result.provider.experience || 0,
          education: result.provider.education || "",
          languages: result.provider.languages || [],
          skills: result.provider.skills || [],
        })
      } else {
